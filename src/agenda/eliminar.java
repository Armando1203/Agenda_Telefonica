...
public class eliminar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Selecciona un contacto para eliminar");
        ...
        btn_Eliminar.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/btn_red.jpg"))); // NOI18N
    ...
    null,
      "¿Seguro de eliminar el contacto?",
       "Confirmación",
    ...
    JOptionPane.QUESTION_MESSAGE,
      ...
      opciones,
            ...
            {
                String telefono = tbl_Contactos.getValueAt(seleccion, 0).toString().replaceAll("\\s", "");
                String sql = "DELETE FROM Contactos WHERE Telefono='"+telefono+"'";
                ...
                try 
                {
                    ...
                    JOptionPane.showMessageDialog(null, "Contacto no eliminado"+e.toString());
                }
            ...
            }else if (opcionSeleccionada == JOptionPane.NO_OPTION){} else{}
